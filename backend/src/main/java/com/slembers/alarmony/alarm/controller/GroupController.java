...
import com.slembers.alarmony.alarm.dto.request.ChangeGroupHostRequestDto;
...
public class GroupController {
    ...
    public ResponseEntity<Void> changeGroupHost(
            @PathVariable(name = "group-id") Long groupId,
            @RequestBody ChangeGroupHostRequestDto changeGroupHostRequestDto
            ) {
        groupService.changeGroupHost(groupId, SecurityUtil.getCurrentUsername(), changeGroupHostRequestDto.getNewHost());
        return ResponseEntity.noContent().build();
    }
