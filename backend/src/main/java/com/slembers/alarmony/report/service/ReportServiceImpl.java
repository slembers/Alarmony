...
public class ReportServiceImpl implements ReportService {
    ...
    public ReportResponseDto getReportDetail(Long reportId) {
        ...
        return ReportResponseDto.builder()
                ...
                .reporterNickname(report.getReporter().getNickname())
                .reportedNickname(
                        report.getReportType().equals(ReportTypeEnum.USER_REPORT) ?
                                report.getReported().getNickname()
                                :
                                ""
                )
    ...
    public void createReport(ReportDto reportDto) {
        ...
        Report report = Report.builder()
                ...
                .reporter(reporter)
                .reported(
                        reportDto.getReportType().equals(ReportTypeEnum.USER_REPORT) ?
                                memberService.findMemberByNickName(reportDto.getReportedNickname())
                                :
                                null
                )
